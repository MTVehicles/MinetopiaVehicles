...
public class VehicleMovement1_14 {
    public static void vehicleMovement(Player p, PacketPlayInSteerVehicle ppisv) {
        ...
        ((org.bukkit.craftbukkit.v1_14_R1.entity.CraftArmorStand) standSkin).getHandle().setLocation(standMain.getLocation().getX(), standMain.getLocation().getY(), standMain.getLocation().getZ(), standMain.getLocation().getYaw(), standMain.getLocation().getPitch());
        mainSeat(standMain, (org.bukkit.craftbukkit.v1_14_R1.entity.CraftArmorStand) standMainSeat, license);
        ...
        if (ppisv.b() > 0.0) {
            ((org.bukkit.craftbukkit.v1_14_R1.entity.CraftArmorStand) standMain).getHandle().setLocation(standMain.getLocation().getX(), standMain.getLocation().getY(), standMain.getLocation().getZ(), standMain.getLocation().getYaw() - Vehicle.getByPlate(license).getRotateSpeed(), standMain.getLocation().getPitch());
        } else if (ppisv.b() < 0.0) {
            ((org.bukkit.craftbukkit.v1_14_R1.entity.CraftArmorStand) standMain).getHandle().setLocation(standMain.getLocation().getX(), standMain.getLocation().getY(), standMain.getLocation().getZ(), standMain.getLocation().getYaw() + Vehicle.getByPlate(license).getRotateSpeed(), standMain.getLocation().getPitch());
        }
        if (ppisv.c() > 0.0) {
