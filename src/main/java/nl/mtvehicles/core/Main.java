...
public class Main extends JavaPlugin {
    ...
    public static String configVersion = "2.3-dev7"; //We might not change config in every version, why bother creating a new config file then? Change this only when necessary.;
